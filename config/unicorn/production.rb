require 'dotenv'
ENV.update Dotenv::Environment.new('.env.production', true)
...
working_directory ENV["UNICORN_WORKING_DIRECTORY"] # available in 0.94.0+

# listen on both a Unix domain socket and a TCP port,
# we use a shorter backlog for quicker failover when busy
listen ENV["UNICORN_SOCKET"], :backlog => ENV["UNICORN_BACKLOG"].to_i
...
before_exec do |server|
  ENV['BUNDLE_GEMFILE'] = ENV["UNICORN_BUNDLE_GEMFILE"]
end
